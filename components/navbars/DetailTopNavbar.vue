...
<template>
  <nav class="flex px-5 py-3 text-white bg-[#202020]">
    <div class="flex w-80 py-2">
      <svg class="mr-5 w-6 h-6 fill-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <span class="text-xs pl-1 text-[#ababab]">CA</span>
    </div>

    <div class="flex-1 items-center justify-center">
      <div class="flex relative text-gray-600">
        <input class="flex-1 h-10 bg-[#181818] p-2 border border-[#3a3a3a]" type="search" name="search"
          placeholder="Search">

        <button type="submit" class="w-16 flex items-center justify-center bg-[#323232]">
